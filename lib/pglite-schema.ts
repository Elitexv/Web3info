...
// Kept as a bundled string (rather than read from prisma/pglite-schema.sql at
// runtime) so it's guaranteed to be included in the Vercel serverless bundle
// for the in-memory demo database.
export const pgliteSchemaSql = `
-- CreateSchema
